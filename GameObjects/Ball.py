...
class Ball(GameItem):
    ...
    def create_ball(self) -> None:
        ...
        self.ball = self.gameboard.create_oval(self.size, self.size * 3, self.size * 3, self.size * 5, fill=self.colour)
    ...
    def move_left(self) -> None:
        ...
        self.gameboard.move(self.ball, self.x, 0)
    ...
    def move_up(self) -> None:
        ...
        self.y = -1
        self.gameboard.move(self.ball, 0, self.y)
