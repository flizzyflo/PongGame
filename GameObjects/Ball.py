...
class Ball(GameItem):
    ...
    def create_ball(self) -> None:
        ...
        self.ball = self.gameboard.create_oval(self.ball_size, self.ball_size * 3, self.ball_size * 3, self.ball_size * 5, fill=self.ball_colour)
    ...
    def handle_ball_plank_collision(self) -> bool:
        ...
        plank_left_edge = self.gameboard.get_coords(self.plank)[0] #x1 value
        plank_upper_edge = self.gameboard.get_coords(self.plank)[1] #y1 value
        plank_right_edge = self.gameboard.get_coords(self.plank)[2] #x2 value
        ball_lower_edge = self.gameboard.get_coords(self.ball)[3] #y2 value
        ...
        if (plank_left_edge <= ball_center_value <= plank_right_edge) and (plank_upper_edge == ball_lower_edge):
            ...
            self.gameboard.increase_playerscore()
            return True
    ...
    def handle_gameborder_collision(self)-> bool:
        ...
        if self.gameboard.get_coords(self.ball)[0] <= 1:
            return True
        
        #right border
        elif self.gameboard.get_coords(self.ball)[2] >= self.gameboard.get_width() - 1:
            return True

        #upper border
        elif self.gameboard.get_coords(self.ball)[1] <= 1:
            return True

        #lower border
        elif self.gameboard.get_coords(self.plank)[1] < self.gameboard.get_coords(self.ball)[3] - 15:
            self.lost_game = True
    ...
    def move_down(self) -> None:
        ...
        if self.handle_ball_plank_collision():
            ...
            self.gameboard.move(self.ball, 0, 0)
