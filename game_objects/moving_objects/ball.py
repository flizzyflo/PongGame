...
class Ball(GameItem):
    ...
    Manages the collision of the ball as well as the positioning of the ball."""

    def __init__(self, gameboard: 'GameBoard', plank: Plank, ball_speed: int, ball_size: int) -> None:
        
        super().__init__(gameboard, ball_speed)
